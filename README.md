...
🚧 Obstacle Course Game: Navigate through an environment filled with moving hazards and checkpoints.

💥 Game Over Mechanics: On-hit detection system resets or ends the game on collision.

🏁 Checkpoints: Progress-saving checkpoints for smoother gameplay experience.
...
C#: All gameplay logic and functionality implemented using C# scripts.

C (Arduino IDE): Captures and interprets analog readings from radio components.
...
Use serial communication to bridge hardware with game software.

Build a fully interactive Unity game environment.

Gain proficiency in writing Unity C# scripts for player controls, UI, and game logic.
...
🧲 Capacitor-based tuning control

🔉 Volume dial wired to act as input

🧪 Custom soldering to exposed contacts
...
[![Watch the video](https://img.youtube.com/vi/i_NvFB_siKE/0.jpg)](https://www.youtube.com/watch?v=i_NvFB_siKE)
...
🔁 Mapping Analog to Gameplay: Translating noisy input to meaningful game movement in Unity was a complex but rewarding task.
